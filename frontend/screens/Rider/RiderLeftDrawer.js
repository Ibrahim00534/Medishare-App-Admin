...
const RiderLeftDrawer = ({ isVisible, toggleDrawer, navigation }) => {
  ...
  return (
    ...
    >
      ...
      >
        <Text style={styles.drawerHeader}>Rider Menu</Text>
        <TouchableOpacity
          style={styles.drawerButton}
          onPress={() => handleNavigation("RiderDashboardScreen")}
        >
          <Text style={styles.drawerButtonText}>Dashboard</Text>
        </TouchableOpacity>
        <TouchableOpacity
          style={styles.drawerButton}
          onPress={() => handleNavigation("RidesAssigned")}
        >
          <Text style={styles.drawerButtonText}>Assigned Deliveries</Text>
        </TouchableOpacity>
        <TouchableOpacity
          style={styles.drawerButton}
          onPress={() => handleNavigation("RidesCompleted")}
        >
          <Text style={styles.drawerButtonText}>Completed Deliveries</Text>
        </TouchableOpacity>
        <TouchableOpacity
          style={styles.drawerButton}
...
export default RiderLeftDrawer;

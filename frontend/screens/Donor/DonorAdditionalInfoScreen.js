...
// const DonorAdditionalInfoScreen = ({ navigation, route }) => {
...
//       Alert.alert('Success', 'Donor info submitted successfully!');
...
// export default DonorAdditionalInfoScreen;
import React, { useState } from 'react';
import {
  View,
  TextInput,
...
const DonorAdditionalInfoScreen = ({ navigation, route }) => {
  ...
  return (
    ...
    >
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        <Text style={styles.title}>Donor Additional Information</Text>
        <TextInput
          style={styles.input}
          placeholder="ID Card Number (e.g. 37405-1234567-7)"
          value={idCardNumber}

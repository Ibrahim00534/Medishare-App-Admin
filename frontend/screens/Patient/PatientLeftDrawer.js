  ...
  return (
    <Modal transparent={true} animationType="none" visible={isVisible} onRequestClose={toggleDrawer}>
      ...
      <Animated.View style={[styles.drawerContainer, { transform: [{ translateX: slideAnim }] }]}>
        ...
        <TouchableOpacity style={styles.drawerButton} onPress={() => handleNavigation('PatientDashboardScreen')}>
          <Text style={styles.drawerButtonText}>Home</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.drawerButton} onPress={() => handleNavigation('PatientMyRequestsScreen')}>
          <Text style={styles.drawerButtonText}>Your Requests</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.drawerButton} onPress={() => handleNavigation('PatientDonationsList')}>
          <Text style={styles.drawerButtonText}>Your Donations</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.drawerButton} onPress={() => handleNavigation('PatientProfile')}>

...
const DonorBottomNav = ({ navigation }) => {
  // Separate navigation functions for each button
  const handleMedicineNavigation = () => {
    navigation.navigate("DonorMedicineList");
  };

  const handleDonationNavigation = () => {
    navigation.navigate("DonorDonationsList");
  };
  ...
  return (
    <View style={styles.bottomNav}>
      ...
      <TouchableOpacity style={styles.navItem} onPress={handleDonationNavigation}>
        <Text style={styles.navIcon}>📝</Text>
        <Text style={styles.navLabel}>Donations</Text>
      </TouchableOpacity>
